<div class="container mx-auto mt-2">
   <x-jet-banner />
    <div class="flex content-center m-2 p-2">
        <x-jet-button wire:click="showCreatePostModal" class="bg-green-500">ADD NEW PRODUCT</x-jet-button>
    </div>
 ...
 <x-jet-dialog-modal wire:model="showModalForm">
  ...
  <form enctype="multipart/form-data">
    ...
    <div class="sm:col-span-6">
      <label for="title" class="block text-sm font-medium text-gray-700"> Product Price </label>
      <div class="mt-1">
        <input type="text" id="price" wire:model.lazy="price" name="price" class="block w-full transition duration-150 ease-in-out appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
      </div>
